...
{}
  ...
  :entries $ {} $ :default
    {} (:description |)
      ...
      :mode :native
      :reload-fn 'pointed-prompt.app.main/reload!
      :feature-policy $ {}
      :modules $ []
      :type-slots $ {}
  :files $ {}
            ...
            if (some? @*box-root)
              let
                  created $ if (some? @*box-root)
                    js/parseFloat $ .-createdTime $ unsafe-coerce
              ...
              set! (.-style input)
                style->string $ merge layout-expand style-input
                  ...
                  unsafe-coerce
                    ...
                    :: 'Map 'Tag 'Dynamic
              set! (.-style control)
                style->string $ merge layout-column $ {} (:justify-content |space-evenly)
